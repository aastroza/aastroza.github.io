...
<div class="site-hero mb-5">
  <div class="site-intro">
    ...
    <p class="site-into fs-5">
      ...
      <strong">Data Science Institute</strong> of
      <a href="https://ingenieria.udd.cl/persona/alonso-astroza-tagle/">Universidad del Desarrollo</a>. I build data products that help organizations to get value from AI.
    </p>
  ...
  <div class="site-logo order-first order-sm-last text-primary">
    ...
    >
      ...
      <g id="letter-g">
        <path
          id="g"
          d="M20.824,29.931l-1.396-3.676H7.529L6.13,30.011c-0.547,1.464-1.012,2.451-1.398,2.965
