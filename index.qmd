...
<div class="site-hero mb-5">
  <div class="site-intro">
    ...
    <p class="site-into fs-5">
      If you need help solving a problem using <strong>data</strong>, I’d love to <a class="mt4 action text" href="/consuling">assist</a> you. I enjoy building new connections and would be happy to <a class="mt4 action text" href="/contact">discuss</a> how we can work together. Let's connect!
    </p>
